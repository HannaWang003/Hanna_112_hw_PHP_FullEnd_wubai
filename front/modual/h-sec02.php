...
<section data-bgcolor="#000"  id="NewsH2" style="overflow:hidden">
    <div style="position:absolute;">
        <h1><span data-scroll data-scroll-speed=3 style="color:yellow;mix-blend-mode:difference;backgroun;">WHAT</span>
            <span>NEWS</span>
...
foreach($news as $new){
    ...
    ?>
    <div>
<h4 data-scroll data-scroll-speed=<?=$a?> class="my-5" style="background:black;mix-blend-mode:difference;color:yellow"><?=$new['title']?> - <?=$new['date']?></h4>
</div>
<?php
