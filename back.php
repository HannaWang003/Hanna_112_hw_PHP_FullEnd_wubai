...
<body style="background:url(./img/2008flower_1_07.jpeg) black;background-size:cover;background-repeat:no-repeat;background-position:bottom right;background-attachment:fixed;color:#ccc;text-weight:bolder">
    <div id="frame">
