...
<body style="background:url(./img/500-125.jpg) black;background-size:contain;background-repeat:no-repeat;background-position:top right;background-attachment:fixed;">
    <?php
    $do = ($_GET['do']) ?? 'main';
    $file = "./front/{$do}.php";
